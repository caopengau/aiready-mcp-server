...
export default function BlogCard({
  ...
  return (
    <Link href={`/blog/${slug}`} className="block group h-full">
      <div className="glass-card p-10 h-full border-white/10 hover:border-cyber-green/40 transition-all bg-black hover:bg-zinc-950 shadow-[0_0_60px_rgba(0,0,0,0.6)] flex flex-col relative overflow-hidden">
        {/* Neon Glow on Hover */}
